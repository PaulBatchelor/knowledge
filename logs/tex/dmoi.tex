...
\smallskip
\noindent 04 euler trails circuits \leaders\hbox to 10pt {\hss.\hss}  \hfill \xref{node14}
\smallskip
...
{\noindent \bf 2026-04-24:} 04 euler trails circuits\smallskip
\vfill \break
\xrdef{node0}
...
{\smallskip\noindent\bf\font\titlefont=cmr12 at 13pt\titlefont $\bullet$ 10:39: wondering if I should applying my skimming technique for DMOI}\smallskip
Better to skim it than do nothing at all?
\par

I've been doing a thing with my BU calculus textbook where I build an outline of a section of a chapter rather than attempt to read it cover to cover. This is a pretty predictable textbook. A section of a chapter contains subsections, examples, theorems, and definitions. With words to elaborate what has been explained.
\par

In DMOI, there are subsections, examples, theorems, and proofs.
\par

I'm thinking I could build a map (with page numbers), transcribe the map, and then (time permitting), dive into examples more deeply.
\par

So, this would be more breadth-first than depth-first. Hours in the day, etc.
\par
...
\xrdef{node14}
{\medskip\noindent\bf\font\titlefont=cmss17 at 20pt\titlefont 04 euler trails circuits}\medskip

{\medskip\noindent\bf\font\titlefont=cmitt12 at 17pt\titlefont 2026-04-24}\medskip
{\smallskip\noindent\bf\font\titlefont=cmr12 at 13pt\titlefont $\bullet$ 10:10: might be able to glance at this after may 5th}\smallskip
It'll be interesting to see what I am able to grok after time away working on calculus. I definitely have more math in my bloodstream now, but all my discrete math has some distance now.
\par
