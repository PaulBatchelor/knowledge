...
WHAT. how did is it almost 23:00. This is why it's good to cut back on coding. You lose so much time in your life.
\par
...
I think these new abbreviations triggered a bug for some old test code. {\tt test_rw} is using a command it calls {\tt clr}, when I think it's supposed to be {\tt cl}.
\par
